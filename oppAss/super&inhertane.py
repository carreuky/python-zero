...
class Triangle(Polygon):
    ...
    def __init__(self, side1,side2,side3):
        ...
        self.side2 = side2
        self.side3 = side3
        self.sides = [side1,side2,side3] #faster way to solve get sides question
...
class Square(Rectangle):
    ...
    def __init__(self, side_length):
        super().__init__(side_length, side_length)#width, hieght allows us to use Rectangle values using super
